...
const projectsDescription =
  "View TDS Energies projects across water access, renewable energy, hydrogen innovation, and drilling infrastructure in South Africa.";
...
const projects = [
  {
    ...
    description:
      "Community-focused borehole and solar pump delivery designed to expand dependable access to clean water.",
  ...
  },
  {
    ...
    description:
      "Commercial solar generation built to reduce energy cost exposure and improve supply resilience.",
  ...
  },
  {
    ...
    description:
      "Early-stage hydrogen work supporting cleaner industrial energy pathways and future fuel capability.",
  ...
  },
  {
    ...
    description:
      "Specialized drilling support for mining environments where safety, precision, and uptime are critical.",
  ...
  return (
    <>
      ...
      <main className="bg-[#1a1a1a]">
        ...
        <section className="relative mt-16 h-[42vh] min-h-[340px] flex items-center justify-center px-4 overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-4xl px-4">
            ...
            >
              Delivering sustainable infrastructure solutions across South
              Africa.
            </motion.p>
          </div>
        </section>
